...
async function buildEnv() {
  ...
  return {
    ...
    EXPECTED_VERSION: envValue("EXPECTED_VERSION", "V17.3.14-BALANCE-RESOLUTION-ONCHAIN-GUARD"),
...
async function main() {
  ...
  console.log("[GITHUB][START]", {
    ...
    expectedVersion: envValue("EXPECTED_VERSION", "V17.3.14-BALANCE-RESOLUTION-ONCHAIN-GUARD"),
